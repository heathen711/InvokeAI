// src/features/ui/components/mobile/canvas/MobileCanvasGenerateForm.tsx
import {
  Box,
  Button,
...
import { useEnqueueCanvas } from 'features/queue/hooks/useEnqueueCanvas';
...
import { PiCaretDownBold, PiShuffleBold, PiSparkleFill, PiXBold } from 'react-icons/pi';
...
export const MobileCanvasGenerateForm = memo(({ onClose, onGenerationStarted }: MobileCanvasGenerateFormProps) => {
  ...
  return (
    <>
      <Flex flexDirection="column" width="full" height="full" overflow="auto" pb={4}>
        <VStack spacing={4} p={4} width="full">
          ...
          {/* Generate Button & Queue Controls */}
          ...
          {/* Close Button */}
          <Button onClick={onClose} variant="ghost" size="lg" w="full" leftIcon={<PiXBold />}>
            Close
          </Button>
        </VStack>
      </Flex>
...
MobileCanvasGenerateForm.displayName = 'MobileCanvasGenerateForm';
